...
export default function PowerSupplyPage({featuredCategoryList}) {
  const powerSupplyFeaturedData = featuredCategoryList.data.filter(item=> item.category == 'PowerSupply')
    ...
    return (
      <>
        ...
        >
          {powerSupplyFeaturedData?.map((product) => (
