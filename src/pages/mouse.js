...
export default function Mouse({featuredCategoryList}) {
  const mouseFeaturedData = featuredCategoryList.data.filter(item=> item.category == 'Mouse')
