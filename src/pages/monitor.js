...
export default function Monitor({featuredCategoryList}) {
  const monitorFeaturedData = featuredCategoryList.data.filter(item=> item.category == 'Monitor')
    ...
    return (
      <>
        ...
        >
          {monitorFeaturedData?.map((product) => (
