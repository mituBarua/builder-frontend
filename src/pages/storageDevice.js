...
export default function StorageDevice({featuredCategoryList}) {
  const storageDeviceFeaturedData = featuredCategoryList.data.filter(item=> item.category == 'StorageDevice')
    ...
    return (
      <>
        ...
        >
          {storageDeviceFeaturedData?.map((product) => (
